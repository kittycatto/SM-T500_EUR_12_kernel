deps_config := \
	...
	drivers/power/supply/afc/Kconfig \
...
ifneq "$(CC)" "/home/f/Projects/SM-T500_EUR_12_kernel/../clang/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/f/Projects/SM-T500_EUR_12_kernel/../aarch64-linux-android-4.9/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/f/Projects/SM-T500_EUR_12_kernel/../aarch64-linux-android-4.9/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/f/Projects/SM-T500_EUR_12_kernel/../aarch64-linux-android-4.9/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/home/f/Projects/SM-T500_EUR_12_kernel/../aarch64-linux-android-4.9/bin/aarch64-linux-android- --gcc-toolchain=/home/f/Projects/aarch64-linux-android-4.9 -no-integrated-as -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
